...
async def telegram_worker():
    """Tâche dédiée — consomme la queue et envoie les alertes"""
...
def analyser_trade_streaming(data: dict):
    """Analyse chaque trade en temps réel"""
    mint = data.get("mint")
...
async def solana_websocket_listener():
    ...
    print("=== [BOT] Sniper Pré-Migration Pump.fun démarré ===")
